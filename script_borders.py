#!python3
"""
O script_borders.py gera, a partir das imagens das pedras, uma imagem contendo o contorno em branco
da pedra. Baseado em um algoritmo de um seguidor de linha, ou "ceguinho", ao algoritmo perceber
que tal parte da imagem sai do threshold do que seria uma cor da pedra, seta tal posição como sendo
uma borda.
...
for entry in lista_imagens:
    ...
    new_img.itemset((current_y -1, current_x, 0), 255)
    new_img.itemset((current_y -1, current_x, 1), 255)
    new_img.itemset((current_y -1, current_x, 2), 255)        
    # Vira à direita
    init_x = current_x
    init_y = current_y
    ...
    if pixel_b < 20 and pixel_g < 20 and pixel_g < 20:
        ...
        new_img.itemset((current_y, current_x + 1, 0), 255)
        new_img.itemset((current_y, current_x + 1, 1), 255)
        new_img.itemset((current_y, current_x + 1, 2), 255)
    ...
    cv2.imwrite(str(entry)+"_borders", new_img)
