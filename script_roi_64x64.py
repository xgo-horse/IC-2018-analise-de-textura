#!python3
"""
script_roi_64x64.py gera um arquivo arff contendo as entropias analizando uma area de 64x64.
...
with open("entropia64x64","w") as f:
    ...
    for entry in lista_imagens:
        ...
        #Recorta um quadrado de 64x64 tendo como meio o pixel central
        roi = img[middlex-32:middlex+32,middley-32:middley+32]
