#!python3
"""
script_roi_32x32.py gera um arquivo arff contendo as entropias analizando uma area de 32x32.
...
with open("entropia32x32","w") as f:
    ...
    for entry in lista_imagens:
        ...
        #Recorta um quadrado de 32x32 tendo como meio o pixel central
        roi = img[middlex-16:middlex+16,middley-16:middley+16]
        '''##
        rows,cols = roi.shape[:2]
        center = ((cols-1) / 2, (rows-1) / 2)
        #cv2.imshow("not rotated", roi)
        cv2.waitKey(0)
